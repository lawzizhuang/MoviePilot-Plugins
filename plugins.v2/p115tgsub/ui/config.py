...
class UIConfig:
    ...
    def get_form() -> Tuple[List[dict], Dict[str, Any]]:
            ...
            "content": [
                ...
                },
                {
                    ...
                    "content": [
                        ...
                        {"component": "VCol", "props": {"cols": 12, "md": 3}, "content": [{"component": "VTextField", "props": {"model": "dmhy_rss_keyword_budget", "label": "每轮作品关键词RSS上限", "type": "number", "placeholder": "6", "hint": "主名、原名各一次；命中后不再读滚动Feed。"}}]},
        ...
        defaults = {
            "bot_transfer_enabled": False, "bot_transfer_users": "",
            ...
            "dmhy_rss_enabled": False, "dmhy_rss_timeout": 20, "dmhy_rss_interval_seconds": 5, "dmhy_rss_use_proxy": False, "dmhy_rss_keyword_budget": 6,
